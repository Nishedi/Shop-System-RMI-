module lab07.pop {
     ...
     * Plik jar został stworzony za pomocą komendy
     * jar -cfv lab07_pop.jar -C bin . src
     ...
     * W celu uruchomienia aplikacji z zależnością należy na początku uruchomić komendę
     * set CLASSPATH=gadgets.jar
     * nastepnie
     * java -p gadgets.jar;lab07_pop.jar -m lab07.pop/servermain.Server
     * dla serwera
     * java -p gadgets.jar;lab07_pop.jar -m lab07.pop/clientmain.Client host port
     * dla klienta
     * java -p gadgets.jar;lab07_pop.jar -m lab07.pop/sellermain.Seller host port
     * dla sprzedawcy
